...
>
> Zephus also uses Electron which I'm not the proudest about, but seeing as it's a web editor, I figured out of a lot of the options it was the easiest to work with for this project.
>
